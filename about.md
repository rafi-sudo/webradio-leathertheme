...
(function(){
  ...
  var config = {
    number: "6282319885778",
    message: "Permisi, saya tertarik untuk beriklan.",
    color: "#25D366",
    channel: "wa",
    boxShadow: "none",
    text: "Tertarik untuk beriklan",
    theme: "light",
    position: "right",
    mb: "20px",
    mx: "20px",
  ...
  function createWidget() {
    ...
    widget.onclick = function() {
      window.open('https://wa.me/6282319885778?text=Permisi%2C%20saya%20tertarik%20untuk%20beriklan.', '_blank');
    };
